...
glm::vec3 shade(
    ...
    if (!inShadow) {
        ...
        glm::vec3 I_diff = hitObject.K_diffuse * I_F * glm::max(0.0f, glm::dot(l, n));
        glm::vec3 I_spec = hitObject.K_specular * I_F * std::pow(glm::max(0.0f, glm::dot(v, r)), hitObject.shininess);
